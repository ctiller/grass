...
The Win64 frame calculation in `Grass/ABI/Win64/Convention.lean` now derives
the call allocation and saved-register positions from explicit fixture inputs.
...
Computing a fixture layout alone does not establish its connection to source
lowering or emitted instructions.
