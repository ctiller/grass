...
by failure, zero progress, and an empty payload. Failure emission counts are
...
connect the spike specification, whole execution histories, responsiveness,
Win32 providers, or generated bytes. The spike sources remain unchanged.
