...
| [AGENT_REVIEW_SUCCESSOR.md](AGENT_REVIEW_SUCCESSOR.md) | staged successor separating durable source-snapshot acceptance from current-main integration without head-keyed verdicts |
