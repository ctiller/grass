...
param(
    ...
    [string[]]$Declaration = @(
        ...
        "Grass.Specification.RequirementSet.covers_union",
        "Grass.Specification.RequirementSet.demands_union",
        "Grass.Specification.RequirementSet.empty_union",
        "Grass.Specification.RequirementSet.union_assoc",
        "Grass.Specification.RequirementSet.union_comm",
        "Grass.Specification.RequirementSet.union_covers_left",
