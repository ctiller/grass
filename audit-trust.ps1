...
param(
    ...
    [string[]]$Declaration = @(
        ...
        "Grass.TargetOutcomeProjection.successOrFailure_status_success",
        "Grass.TargetOutcomeProjection.successOrFailure_status_failure",
        "Grass.TargetOutcomeProjection.successZeroFailureOne_status_success",
        "Grass.TargetOutcomeProjection.successZeroFailureOne_status_failure",
