...
lake env lean "$audit"
printf "Unchanged Hello frontend, loader-rooted WriteFile entry prefix, and stdout-unavailable terminal prefixes pass; unsupported source rejected. Native/causal correspondence, deadlock freedom, certificate suffix and full repository trust gates remain outside this check.\n"
