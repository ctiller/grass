...
/-! Loader initialization tests over explicit PE descriptions and environment
data. These validate model construction; they do not execute a Windows binary
or establish physical loader correspondence. -/
