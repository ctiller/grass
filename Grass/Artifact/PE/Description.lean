...
This is the ownership boundary agreed with `c-x86`: instruction encoders supply
opaque section bytes and an entry-point RVA; the artifact layer owns container
...
/-- The instruction-independent input to PE image construction. RVAs and flag
words have their serialized widths at the boundary; section and import order is
part of the requested image. -/
